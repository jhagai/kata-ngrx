...
// Deletion
export const deleteTodoRequest = createAction('[Todo] Delete request');
export const deleteTodoSuccess = createAction('[Todo] Delete success');
export const deleteTodoFailure = createAction('[Todo] Delete failure');
